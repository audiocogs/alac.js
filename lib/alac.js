(function() {
  ...
  ALACDecoder = (function() {
    ...
    ALACDecoder.prototype.decode = function(input, offset, samples, channels) {
      var bits1, bytesShifted, chanBits, channelIndex, coefsU, coefsV, denShiftU, elementInstanceTag, escapeFlag, headerByte, i, input_a, maxBits, mixBits, mixRes, modeU, numU, outSamples, output, params, partialFrame, pbFactorU, shift, status, tag, unused, val, _ref, _ref2;
      if (!(channels > 0)) {
        console.log("Requested less than a single channel");
        return ALAC.errors.paramError;
      }
      this.activeElements = 0;
      _ref = [new Int16Array(32), new Int16Array(32)], coefsU = _ref[0], coefsV = _ref[1];
      output = CSAlloc(samples * channels * this.config.bitDepth / 8);
      _ref2 = [offset * 8, 0, new Int16Array(input)], offset = _ref2[0], channelIndex = _ref2[1], input_a = _ref2[2];
      ...
      while (status === ALAC.errors.noError) {
        ...
        switch (tag) {
          ...
          case 3:
            ...
            offset += 4;
            this.activeElements = this.activeElements | (1 << elementInstanceTag);
            ...
            if (partialFrame !== 0) {
              ...
              offset += 16;
              samples = samples | CSLoadManyBits(input, offset, 16);
              offset += 16;
            }
            if (escapeFlag === 0) {
              ...
              if (bytesShifted !== 0) offset += (bytesShifted * 8) * samples;
