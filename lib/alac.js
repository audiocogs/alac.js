(function() {
  ...
  ALACDecoder = (function() {
    ...
    ALACDecoder.prototype.decode = function(input, offset, samples, channels) {
      var bits1, bytesShifted, chanBits, channelIndex, coefsU, coefsV, data, denShiftU, elementInstanceTag, escapeFlag, headerByte, i, maxBits, mixBits, mixRes, modeU, numU, outSamples, output, params, partialFrame, pbFactorU, shift, status, tag, unused, val;
      if (!(channels > 0)) {
  ...
  BitBuffer = (function() {
    ...
    BitBuffer.prototype.read = function(bits) {
      var a, b1, b2, b3;
      b1 = this.data[this.offset] << 16;
      b2 = this.data[this.offset + 1] << 8;
      b3 = this.data[this.offset + 2];
      a = (b1 | b2 | b3) << this.pos;
      a &= 0x00FFFFFF;
      this.advance(bits);
      return a >> (24 - bits);
    ...
    BitBuffer.prototype.readSmall = function(bits) {
      var a, b1, b2;
      b1 = this.data[this.offset] << 8;
      b2 = this.data[this.offset + 1];
      a = (b1 | b2) << this.pos;
      this.advance(bits);
      return a >> (16 - bits);
    };
  ...
  Matrixlib = (function() {
    ...
    Matrixlib.unmix16 = function(u, v, out, stride, samples, mixbits, mixres) {
      var i, l, out_a, u_a, v_a, _results, _results2;
