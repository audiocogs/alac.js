(function() {
  ...
  ALACDecoder = (function() {
    ...
    ALACDecoder.prototype.decode = function(data, offset, samples, channels) {
      var agParams, bits1, bytesShifted, chanBits, channelIndex, coefsU, coefsV, denShiftU, denShiftV, elementInstanceTag, escapeFlag, headerByte, i, maxBits, mixBits, mixRes, modeU, modeV, numU, numV, out16, outSamples, output, params, partialFrame, pb, pbFactorU, pbFactorV, shift, shiftbits, status, tag, unused, unusedHeader, val, _ref, _ref2, _ref3;
      if (!(channels > 0)) {
        ...
        switch (tag) {
          ...
          case ID_CPE:
            ...
            if (escapeFlag === 0) {
              ...
              _ref = Aglib.dyn_decomp(agParams, data, this.predictor, samples, chanBits), status = _ref[0], output = _ref[1];
              ...
              _ref2 = Aglib.dyn_decomp(agParams, data, this.predictor, samples, chanBits), status = _ref2[0], output = _ref2[1];
              if (status !== ALAC.errors.noError) {
                console.log("Mom also said there should be no error");
                return status;
              }
  ...
  Aglib = (function() {
    ...
    dyn_get_32 = function(data, m, k, maxbits) {
      var result, stream, v;
      stream = data.read(input, data.offset + pos >> 3);
      stream <<= pos & 7;
      result = lead(~stream);
    ...
    Aglib.dyn_decomp = function(params, data, pc, samples, maxSize) {
      var bitPos, c, del, j, k, kb, m, mb, multiplier, mz, n, ndecode, pb, start, status, wb, zmode, _ref;
      ...
      while (c < samples) {
        ...
        if (((mb << MMULSHIFT) < QB) && (c < samples)) {
          ...
          mz = ((1 << k) - 1) & wb;
          _ref = dyn_get_16(input, bitPos, mz, k), n = _ref[0], bitPos = _ref[1];
          if (!(c + n <= samples)) {
