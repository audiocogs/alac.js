(function() {
  ...
  ALACDecoder = (function() {
    ...
    function ALACDecoder(cookie) {
      ...
      if (CSCompareToString(this.cookie, offset + 4, 'alac', 0, 4)) {
        offset += 12;
        remaining -= 12;
      ...
      this.config = {
        frameLength: CSLoadBigUInt32(this.cookie, offset + 0),
        compatibleVersion: CSLoadUInt8(this.cookie, offset + 4),
        bitDepth: CSLoadUInt8(this.cookie, offset + 5),
        pb: CSLoadUInt8(this.cookie, offset + 6),
        mb: CSLoadUInt8(this.cookie, offset + 7),
        kb: CSLoadUInt8(this.cookie, offset + 8),
        numChannels: CSLoadUInt8(this.cookie, offset + 9),
        maxRun: CSLoadBigUInt16(this.cookie, offset + 10),
        maxFrameBytes: CSLoadBigUInt32(this.cookie, offset + 12),
        avgBitRage: CSLoadBigUInt32(this.cookie, offset + 16),
        sampleRate: CSLoadBigUInt32(this.cookie, offset + 20)
      };
    ...
    Aglib.dyn_decomp = function(params, bitstream, pc, samples, size) {
      ...
      while (c < samples) {
        ...
        if (((mb << MMULSHIFT) < QB) && (c < samples)) {
          ...
          if (!(c + 1 <= samples)) return ALAC.error.paramError;
