(function() {
  ...
  ALACDecoder = (function() {
    ...
    ALACDecoder.prototype.decode = function(data, offset, samples, channels) {
      var agParams, bits1, bytesShifted, chanBits, channelIndex, coefsU, coefsV, denShiftU, denShiftV, elementInstanceTag, escapeFlag, headerByte, i, j, maxBits, mixBits, mixRes, modeU, modeV, numU, numV, out16, output, params, partialFrame, pb, pbFactorU, pbFactorV, shift, shiftbits, status, tag, unused, unusedHeader, val, _ref;
      if (!(channels > 0)) {
  ...
  Aglib = (function() {
    var BITOFF, KB0, MAX_DATATYPE_BITS_16, MAX_PREFIX_16, MAX_PREFIX_32, MAX_RUN_DEFAULT, MB0, MDENSHIFT, MMULSHIFT, MOFF, N_MAX_MEAN_CLAMP, N_MEAN_CLAMP_VAL, PB0, QB, QBSHIFT, dyn_get_16, dyn_get_32, lead, lg3a;
  ...
  Dplib = (function() {
    ...
    Dplib.unpc_block = function(pc1, out, num, coefs, active, chanbits, denshift) {
      var chanshift, dd, del, del0, denhalf, i, j, lim, offset, prev, sg, sgn, sum1, top, _results;
